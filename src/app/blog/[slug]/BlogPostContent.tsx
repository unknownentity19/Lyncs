...
> = {
  ...
  "lyncs-vs-simplify": {
    ...
    excerpt:
      "Simplify is $39.99/mo for a chrome extension that types your name into a form.",
    date: "May 12, 2026",
    category: "Simplify",
    readTime: "5 min read",
    content: [
      ...
      <article className="py-24 px-6">
        <div className="max-w-3xl mx-auto">
          ...
          >
            <Link
              href="/blog"
              className="link-underline inline-flex items-center gap-1.5 text-sm text-muted hover:text-foreground transition-colors mb-12"
            >
              <ArrowLeft size={14} />
              Back to blog
            </Link>
          ...
          >
            ...
            <Link
              href="/signup"
              className="group btn-shine inline-flex items-center gap-2 bg-foreground text-white px-6 py-3 rounded-full text-sm font-medium hover:bg-foreground/90 transition-all"
            >
              Get started
              <ArrowRight
                size={14}
