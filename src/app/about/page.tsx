...
const teamValues = [
  {
    ...
    detail: "Founders read every message. Bugs, feature requests, edge cases — all welcome.",
  },
  {
    label: "We build in the open.",
    detail: "Changelog is public, AI usage is disclosed, and you can delete your data any time.",
  },
  {
    label: "We respect your time.",
    detail: "No dark patterns, no auto-renew traps, no growth-hack pop-ups asking you to share Lyncs.",
  },
];
          ...
          <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
            {aboutPrinciples.map((principle, index) => (
              <motion.article
                ...
                viewport={{ once: true }}
                transition={{ duration: 0.4, delay: 0.06 * index }}
                className="flex min-h-[260px] flex-col rounded-lg border border-border bg-white p-5 transition-all duration-200 hover:border-foreground/25 hover:shadow-sm"
              >
          ...
          >
            <div>
              ...
              <p className="mt-4 max-w-2xl text-base leading-relaxed text-muted">
                ...
                managers, backed by Y Combinator. We&rsquo;ve sat on both sides
                of the table — submitting hundreds of applications and screening
                thousands of them — and we&rsquo;re building the tool we wish
                had existed.
              </p>
            ...
            <aside className="rounded-lg border border-border bg-white p-6 sm:p-8">
              <div className="flex items-center gap-3">
                <span className="inline-flex h-10 w-10 items-center justify-center rounded-lg bg-orange-500 text-sm font-bold text-white">
                  Y
                </span>
                <div>
                  ...
                  <p className="text-sm font-semibold">Y Combinator</p>
                </div>
              </div>
              ...
              <div className="mt-6 flex flex-col gap-3">
                <a
                  href="mailto:founders@lyncs.com?subject=Hi%20Lyncs"
                  className="inline-flex items-center justify-center gap-2 rounded-full bg-foreground px-5 py-2.5 text-sm font-medium text-white transition-all hover:bg-foreground/90"
                >
                  <Sparkles size={15} />
                  Email the founders
                </a>
